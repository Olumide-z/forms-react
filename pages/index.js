...
export default function Home() {
  ...
  return (
    <m.div initial={{ opacity: 0 }} animate={{opacity: 1}} exit={{ opacity: 0 }} className='absolute w-full'>
      ...
      <main className='flex items-center justify-center my-10 mx-16'>
        <form 
          onSubmit={formik.handleSubmit} 
          className='bg-white flex rounded-lg font-latoRegular w-full'>
            ...
            <div className="mt-6">
              ...
              <div className="pb-4">
                ...
                <select 
                  ...
                  onChange={formik.handleChange}
                  name='country' className="border-2 border-gray-500 p-2 rounded-md w-1/2 focus:border-teal-500 focus:ring-teal-500">
          ...
          <div className="relative flex-1">
            <Image src={formImage} alt="form-learn" fill className="object-cover rounded-lg" priority/>
          </div>
